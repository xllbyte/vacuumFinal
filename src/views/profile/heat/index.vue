...
import { queryHeatValue, updateHeatParam } from '@/service/api/parm';
    ...
    if (
      ...
      const settingArrayDown = settingPreheatArrayValueDown
        ...
        .concat(
          settingHighTemperatureArrayValueDown
            .slice(0, 2)
            .concat(settingVacuumArrayValue.slice(0, 1).concat(settingBurialArrayValueDown.slice(0, 2)))
        );
    ...
    if (
      ...
      const actualArrayDown = actualPreheatArrayValueDown
        ...
        .concat(
          actualHighTemperatureArrayValueDown
            .slice(0, 2)
            .concat(actualVacuumArrayValue.slice(0, 1).concat(actualBurialArrayValuetsDown.slice(0, 2)))
        );
